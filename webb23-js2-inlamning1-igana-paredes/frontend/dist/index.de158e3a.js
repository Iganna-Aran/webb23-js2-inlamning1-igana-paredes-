document.addEventListener("DOMContentLoaded", function() {
    ...
    function determineWinner(playerChoice1, computerChoice) {
        if (playerChoice1 === computerChoice) return "tie";
        else if (playerChoice1 === "rock" && computerChoice === "scissors" || playerChoice1 === "paper" && computerChoice === "rock" || playerChoice1 === "scissors" && computerChoice === "paper") return "player";
        else return "ai";
    }
